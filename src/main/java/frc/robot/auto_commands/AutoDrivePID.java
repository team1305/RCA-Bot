...
public class AutoDrivePID extends PIDCommand {
  ...
  public AutoDrivePID(double setpoint, Subsystem_Drive drive) {
    ...
    super(
        ...
        output -> {drive.arcadedrive(-output, 0);
          // Use the output here
        SmartDashboard.putNumber("encoderValue", -drive.getDistance());
        });
  ...
  public boolean isFinished() {
    return getController().atSetpoint() || Subsystem_Drive.getRoll() < -7;
  }
}
