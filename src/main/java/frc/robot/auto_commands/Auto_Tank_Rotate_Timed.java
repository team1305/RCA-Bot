 ...
 *
 */
public class Auto_Tank_Rotate_Timed extends Command {
    ...
    public Auto_Tank_Rotate_Timed(double AutoRotateAngle, double LeftPower, double RightPower, double TimeOut ) {
